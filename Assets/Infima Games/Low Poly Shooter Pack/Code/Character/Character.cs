...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public sealed class Character : CharacterBehaviour
    {
        ...
        protected override void Start()
        {
            ...
            for(int i = 0; i < inventory.GetLastIndex()+1; i++ )
            {
                inventory.Equip(i);
            }
            inventory.Equip(weaponIndexEquippedAtStart);
        }
        ...
        private void UpdateAnimator()
        {
            ...
            if (characterAnimator.GetBool(boolNameReloading))
            {
                ...
                if (equippedWeapon.GetAmmunitionTotal() - equippedWeapon.GetAmmunitionCurrent() < 1 || equippedWeapon.GetAmmoHave() < 1)
                {
        ...
        public void AddGrenade(int ammount = 1)
        {
            grenadeCount += ammount;
        }
        #endregion
