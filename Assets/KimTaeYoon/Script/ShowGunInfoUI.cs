...
namespace InfimaGames.LowPolyShooterPack.Interface
{
    ...
    /// </summary>
    public class ShowGunInfoUI : Element
    {
        ...
        private void Start()
        {
            inventory = GameObject.FindGameObjectWithTag("Inventory").GetComponent<InventoryBehaviour>();
            weaponBehaviour = inventory.GetWeaponByIndex(gunIndex);
            attachmentManagerBehaviour = weaponBehaviour.GetComponent<WeaponAttachmentManagerBehaviour>();
        }
        ...
        protected override void Tick()
        {
            ...
            attachmentManagerBehaviour = weaponBehaviour.GetAttachmentManager();
            //Update the weapon's body sprite!
            imageWeaponBody.sprite = weaponBehaviour.GetSpriteBody();

            //Ammo
            if (weaponBehaviour.IsinfiniteAmmo())
                ammoText.text = weaponBehaviour.GetAmmunitionCurrent() + " / ¡Ä";
            else
                ammoText.text = weaponBehaviour.GetAmmunitionCurrent() + " / " + weaponBehaviour.GetAmmoHave();
